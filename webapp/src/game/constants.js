...
export const POLICIES = {
  ...
  // Beat-synced dance (duck-mod fine-tune of the walking checkpoint):
  // twist slots carry the beat clock [cos 2πφ, sin 2πφ, tempo_norm] and
  // the body slots carry amplitudes; lazy-loaded when music first plays.
  dance: `${POLICY_DIR}/beat_dance_head.onnx`,
